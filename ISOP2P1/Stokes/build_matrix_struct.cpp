		...
		for (int j = rowstart[i]; j < rowstart[i + 1]; ++j)
		{
			if (i >= 0 && i < l_i1)
			{
				...
				else if (column[j] >= l_j2 && column[j] < l_j3)
				{
					...
					{
						std::cout << "Matrix structure error, (0, 2)!" << std::endl;
						exit(-1);
					}
					else
					{
			...
			else if (i >= l_i1 && i < l_i2)
			{
				if (column[j] == i)
				{
					...
					{
						std::cout << "Matrix structure error, diag of (1, 0)!" << std::endl;
						exit(-1);
					}
					else
					{
				...
				else if (column[j] >= l_j1 && column[j] < l_j2)
				{
					...
					{
						std::cout << "Matrix structure error, (1, 2)!" << std::endl;
						exit(-1);
					}
					else
					{
			...
			else if (i >= l_i2 && i < l_i3)
			{
				if (column[j] >= 0 && column[j] < l_j1)
					...
					{
						std::cout << "Matrix structure error, (2, 0)!" << std::endl;
						exit(-1);
					}
					else
					{
					...
					{
						std::cout << "Matrix structure error, (2, 1)!" << std::endl;
						exit(-1);
					}
					else
					{
					...
					{
						std::cout << "Matrix structure error, (2, 2)!" << std::endl;
						exit(-1);
					}
					else
					{
